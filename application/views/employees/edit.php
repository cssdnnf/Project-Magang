                            ...
                            <div class="card stretch stretch-full">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="division">
                                                <option value="IT" <?= $emp['division'] == 'IT' ? 'selected' : ''; ?>>IT</option>
                                                <option value="HR" <?= $emp['division'] == 'HR' ? 'selected' : ''; ?>>HR</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="address" rows="3"><?= $emp['address']; ?></textarea>
                                    </div>
                                    <div class="text-end">
